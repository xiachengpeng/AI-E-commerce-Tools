...
const MODULES_CONFIG = [
    { id: 'm1', title: '首屏认知', promptTitle: 'Hero Product Understanding', subtitle: '让用户秒懂产品', active: true, count: 1, includeText: true, prompt: "Create a clear hero section that immediately explains what the product is, who it is for, and the primary benefit. Use one short headline, one short support line, and up to three proof-oriented callouts." },
    { id: 'm2', title: '核心功能证明', promptTitle: 'Core Benefit Proof', subtitle: '给出购买理由', active: true, count: 1, includeText: true, prompt: "Create a focused benefit infographic. Each version must cover a different buying reason, with no repeated headline angle across variants." },
    { id: 'm3', title: '场景/痛点唤醒', promptTitle: 'Usage Scenario and Pain Point', subtitle: '展示真实使用需求', active: true, count: 1, includeText: true, prompt: "Create a believable lifestyle usage scene with realistic product scale, natural lighting, and a single user context. Avoid exaggerated fitness transformations." },
    ...
    { id: 'm9', title: '对比差异证明', promptTitle: 'Objective Comparison Proof', subtitle: '说明为什么选它', active: true, count: 1, includeText: true, prompt: "Create an objective comparison table between a single-function alternative and this product. Use factual feature rows, not exaggerated superiority claims." },
    { id: 'm10', title: '参数规格确认', promptTitle: 'Specification Confirmation', subtitle: '用事实消除顾虑', active: true, count: 1, includeText: true, prompt: "Create a clean specification section. Only show parameters that are present in the supplied product information or clearly visible in the reference image." },
    { id: 'm11', title: '信任/售后背书', promptTitle: 'Trust and After-Sales Support', subtitle: '降低下单风险', active: true, count: 1, includeText: true, prompt: "Create a trust-building after-sales section using warranty, support, shipping, returns, maintenance, or package-list cues only when provided. Do not invent certifications." },

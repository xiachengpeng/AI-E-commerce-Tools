...
const MODULES_CONFIG = [
    ...
    { id: 'm3', title: '场景/痛点唤醒', promptTitle: 'Usage Scenario and Pain Point', subtitle: '展示真实使用需求', active: false, count: 1, includeText: true, prompt: "Create a believable lifestyle usage scene with realistic product scale, natural lighting, and a single user context. Avoid exaggerated fitness transformations." },
